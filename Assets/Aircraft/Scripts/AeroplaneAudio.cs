...
namespace UnityStandardAssets.Vehicles.Aeroplane
{
    public class AeroplaneAudio : MonoBehaviour
    {
        ...
        public class AdvancedSetttings // A class for storing the advanced options.
        {
            ...
            public float engineMaxDistance = 10000000f;                 // The max distance of the engine audio source.
            ...
            public float windMaxDistance = 100000f;                    // The max distance of the wind audio source.
